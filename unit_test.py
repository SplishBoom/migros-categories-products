...
def retrieve_main_categories(client) :
...
def retrieve_sub_category_list(name, link, client) :
    catalog = {}
...
def scrapper() :
    ...
    category_link_map = retrieve_main_categories(client)

    for name, link in category_link_map.items() :
        retrieve_sub_category_list(name, link, client)
